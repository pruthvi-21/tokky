...
class ViewFinderOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val boxPaint: Paint = Paint().apply {
        color = ContextCompat.getColor(context, R.color.barcode_scanner_overlay_stroke)
        style = Paint.Style.STROKE
        strokeWidth = context.resources.getDimensionPixelOffset(R.dimen.barcode_scanner_overlay_stroke_width).toFloat()
    }

    private val scrimPaint: Paint = Paint().apply {
        color = ContextCompat.getColor(context, R.color.barcode_scanner_background)
    }
    ...
    private val boxCornerRadius: Float =
        context.resources.getDimensionPixelOffset(R.dimen.barcode_scanner_overlay_stroke_radius).toFloat()
